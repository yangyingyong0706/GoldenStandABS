define(function (require) {
        ...
        vm = new Vue({
            ...
            methods: {
                ...
                downloadExcel: function () {
                    ...
                    var callApi = new CallApi('TrustManagement', 'Asset.usp_getCashflowCollection_Purpose', true);
    ...
    function initChkOptions() {
        if (reportingDateId && schedulePurpose == 1) {
            vm.chkOptions.push({ type: '基础池', text: reportingDateId, id: -1, dimreportingdateid: reportingDateId, sel: 1 });
        }else if (reportingDateId) {
            vm.chkOptions.push({ type: '基础池', text: reportingDateId, id: -1, dimreportingdateid: reportingDateId, sel: 0 });
        }
        if (poolIds) {
