                ...
                splitRuleOptionList[i].onclick = function () {
                    ...
                    switch (thisVal) {
                        ...
                        case "等本等息":
                            ...
                            $("#CountLastInterestPeriodByDay").change(function () {
                                selectmode(true, true, true, false, true, true, true, true, 2, thisVal);
                            });
                            $("#TrailPeriodsCalRule").change(function () {
                                selectmode(true, true, true, false, true, true, true, true, 2, thisVal);
                            });
                            $("#AdjustLastPaymentBalance").change(function () {
                                selectmode(true, true, true, false, true, true, true, true, 2, thisVal);
                            });
                            $("#AdjustBalaceDirection").change(function () {
                                selectmode(true, true, true, false, true, true, true, true, 2, thisVal);
                            });
                            $("#AdjustBalacePosition").change(function () {
                                selectmode(true, true, true, false, true, true, true, true, 2, thisVal);
                            });
