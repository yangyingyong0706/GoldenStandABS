define(function (require) {
    ...
    $('#downLoadCFOAPD').click(function () {
        GSDialog.open('模板下载', './DataTwoDownloadTemplate.html', '', function (result) {
            if (result) {
                ...
                if (IsReportGuide == 1) {
                    var executeParams = {
                        SPName: 'TrustManagement.usp_GenerateUploadLog', SQLParams: [
                            ...
                            { Name: 'OperationType', value: 4, DBType: 'string' }
    ...
    function UpCashflowDetailsTaskProcess(filePath) {
        ...
        var taskCode = 'ImportCashFlowOAAccountsPaid';
        if (enter) {
            appDomain = 'Task';
    ...
    function RenderGrid() {
        var filter = " and OperationType=" + 4;
        var svcUrl = GlobalVariable.DataProcessServiceUrl + "CommonExecuteGet?";
