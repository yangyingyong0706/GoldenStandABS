define(['knockout', 'app/productManage/TrustManagement/TrustFollowUp/viewFllowUpPageMain', 'knockout.mapping'], function (ko, followUpMain,mapping) {
    var TrustExtensionNameSpace = {
        ...
        GetTEResultTemplate: function (ItemCode, ItemValue) {
            return followUpMain.TrustFllowUp.api.getTemplate(ItemCode, ItemValue);
        },
        //---------------------页面逻辑----------------------
        ...
        TrustExtensionElement: {
            init: function () {
                ...
                if (self.isFirst) {
                    ...
                    self.TrustExtensionData = mapping.fromJS(self.TrustExtensionData);
    ...
    followUpMain.TrustFllowUp.registerMethods(TrustExtensionNameSpace.TrustExtensionElement);

    return {
        TrustExtensionNameSpace: TrustExtensionNameSpace
        }
});
