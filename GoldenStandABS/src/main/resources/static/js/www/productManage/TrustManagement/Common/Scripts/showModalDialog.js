...
define(function (require) {
    ...
    //var vardialog = require('anyDialog');
    //var vardialog01 = require('GoldenStandABS\asset\lib\goldenstand\anyDialog');
    ...
    //            }
    //        },
    //        adjustWidth: function () { $('<iframe id="iframeDialog"/>').css("width", "100%"); }
    //    };
    ...
    //    if (opts.scrollable)
    //        $('<iframe id="iframeDialog" />').css('overflow', 'auto');

    //    $('<iframe id="iframeDialog" />').css({
    //        'padding': 0,
    //        'margin': 0,
    //        'padding-bottom': 10
    //    });

    //    var $dialogWindow = $('<iframe id="iframeDialog" />').anyDialog({
    //        autoOpen: true,
    //        modal: true,
    //        width: opts.width,
    //        height: opts.height,
    ...
    //    $('<iframe id="iframeDialog"/>').attr('src', opts.url);
    //    fns.adjustWidth();

    //    $('<iframe id="iframeDialog"/>').load(function () {
    //        if ($dialogWindow) {
    ...
    showModalDialog.prototype = {
        getParentWindowWithDialog: function () {
            var p = window.parent;
            var previousParent = p;
            while (p != null) {
                if ($(p.document).find('#iframeDialog').length) return p;
        ...
        setWindowReturnValue: function (value) {
            if ($dlg) $dlg.returnValue = value;
            window.returnValue = value; // in case popup is called using showModalDialog
        },

        getWindowReturnValue :function() {
