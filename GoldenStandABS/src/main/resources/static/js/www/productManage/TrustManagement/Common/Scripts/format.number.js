    ...
    FormatNumber.prototype = {
        ...
        checkNumberFunc: function (settings, eventall, datasource) {
            ...
            var checkNumber = function (e, callback) {
                ...
                //debugger
                //GetNumberResult(e, e.currentTarget, _this.settings.reg);
                //var v = _this.getMoneyfloat($(e.currentTarget).val());
                callback(v);
            }
     ...
     */
        convertNumberN: function (key, value, reg) {
            ...
            tempValue = tempValueArray.length > 1 ?
                (tempValueArray[0].length > 13 ? tempValueArray[0].substr(0, 13) : tempValueArray[0]) + "." + tempValueArray[1] :
                (tempValue.length > 13 ? tempValue.substr(0, 13) : tempValue);
