...
define(function (require) {
    ...
    var locatedURL = require('globalVariable');
    ...
    function roleOperate() {
        this.basicalURL = locatedURL.SslHost;
        this.dbName = 'QuickFrame';
        this.schema = 'QuickFrame';
        this.siteAppUrl = locatedURL.SslHost + '/' + siteApp();
        this.roleService = locatedURL.SslHost + '/' + siteApp() + '/FrameService.svc/';
        this.QucikFrameRoleService = locatedURL.QuickFrameServiceUrl;
    };
    ...
    roleOperate.prototype = {
        ...
        pathPremisson: function (applicationName, path, userName, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_PathPermission','Params':{'ApplicationName':'" + applicationName + "','Path':'" + path + "','UserName':'" + userName + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
                url: serviceUrl,
                dataType: "json",
        ...
        modulePremisson: function (applicationName, path, module, userName, callback) {
            ...
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_ModulePermission','Params':{'ApplicationName':'" + applicationName + "','Path':'" + path + "','Module':'" + module + "','UserName':'" + userName + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        getAllUsers: function (callback) {
            ...
            var serviceUrl = this.roleService + "DataRead?dbName=" + this.dbName + "&schema=" + this.schema + "&json=" + sContent;
            $.ajax({
                url: serviceUrl,
                type: "GET",
        ...
        saveApplicationData: function (xml, flag, applicationId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveApplication','Params':{'items':'" + xml + "','Flag':'" + flag + "','ApplicationId':'" + applicationId + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        saveApplicationsRoles: function (xml, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveApplicationsRoles','Params':{'Items':'" + xml + "'}}"
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        savePath: function (xml, applicationId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SavePath','Params':{'items':'" + xml + "','ApplicationId':'" + applicationId + "'}}"
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        getAppInfoById: function (applicationId, callback) {
            ...
            var serviceUrl = this.roleService + "DataRead?dbName=" + this.dbName + "&schema=" + this.schema + "&json=" + json;
            $.ajax({
                url: serviceUrl,
                type: "GET",
                contentType: "application/json; charset=utf-8",
        ...
        deleteAppById: function (applicationId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteApplicationById','Params':{'ApplicationId':'" + applicationId + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deleteApplicationRoleById: function (applicationId, roleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteApplicationRoleById','Params':{'ApplicationId':'" + applicationId + "','RoleId':'" + roleId + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deletePathById: function (pathId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeletePathById','Params':{'PathId':'" + pathId + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        saveRolesData: function (xml, flag, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveRole','Params':{'Items':'" + xml + "','Flag':" + flag + "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deleteRoleById: function (roleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteRoleById','Params':{" +
                "'RoleId':'" + roleId + "'" +
                "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
        ...
        deleteUserById: function (userId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteUserById','Params':{" +
                "'UserId':'" + userId + "'" +
                "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
        ...
        isExistUsername: function (userName, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_IsExistUserName','Params':{'userName':'" + userName + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        isExistPassword: function (userName, password, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_IsExistPassword','Params':{'UserName':'" + userName + "','Password':'" + password + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        updateProfile: function (xml, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_UpdateProfile','Params':{'item':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        addUser: function (xml, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_AddUser','Params':{'item':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        saveUser: function (xml, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveUser','Params':{'item':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        updateLastLoginDate: function (userName) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_LastLoginDate','Params':{'UserName':'" + userName + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        saveModule: function (xml, callback) {
            ...
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveModule','Params':{'Items':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deleteModuleById: function (moduleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteModuleById','Params':{" +
                "'ModuleId':'" + moduleId + "'" +
                "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
        ...
        getRolesByUserName: function (userName, callback) {
            ...
            var serviceUrl = this.QucikFrameRoleService + "DataRead?dbName=" + this.dbName + "&schema=" + this.schema + "&json=" + sContent;
        ...
        saveModuleRoles: function (xml, callback) {
            xml = encodeURIComponent(xml);
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveModuleRoles','Params':{'Items':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deleteModuleRole: function (moduleId, roleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteModuleRole','Params':{" +
                "'ModuleId':'" + moduleId + "'" +
                ",'RoleId':'" + roleId + "'" +
                "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
        ...
        savePathRoles: function (xml, callback) {
            xml = encodeURIComponent(xml);
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SavePathRoles','Params':{'Items':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        saveUsersRoles: function (xml, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SaveUsersRoles','Params':{'item':'" + xml + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        deleteUsersRoles: function (userId, roleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeleteUsersRoles','Params':{" +
               "'UserId':'" + userId + "'," +
               "'RoleId':'" + roleId + "'" +
               "}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
        ...
        deletePathRoles: function (pathId, roleId, callback) {
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_DeletePathRoles','Params':{'PathId':'" + pathId + "','RoleId':'" + roleId + "'}}";
            json = "<SessionContext>{0}</SessionContext>".format(json);
            var serviceUrl = this.roleService + "DataCUD";
            $.ajax({
                type: "POST",
        ...
        savePermissionById: function (xml, roleId, callback) {
            xml = encodeURIComponent(xml);
            var json = "{'DBName':'" + this.dbName + "','Schema':'" + this.schema + "','SPName':'usp_SavePermissionById','Params':{'Items':'" + xml + "','RoleId':'" + roleId + "'}}";
