define(function (require) {
    ...
    function bindAssetPaymentScheduleData() {
        ...
        if (accountNo) {
            ...
            spName = 'Asset.usp_GetCreditCardAssetPaymentSchedule';
    ...
    function bindListView(data) {
        ...
        $('#listViewContainer').datagrid({
            data: data,
            col: [{ field: "StartDate", title: "回款日", sortable: true, attrHeader: settable.tableTh, attr: settable.tableTd }
