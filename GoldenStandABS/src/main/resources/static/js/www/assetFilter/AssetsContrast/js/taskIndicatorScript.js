define(['jquery', 'loading', 'common', 'gs/webProxy'], function ($, loading, common, webProxy) {
    ...
    var TaskProcessIndicatorHelper = function (isCashflow) {
        ...
        var TaskProcessEngineServiceURL = webProxy.baseUrl + '/TaskProcessEngine/SessionManagementService.svc/jsAccessEP/';
        var CashFlowStudioServie = webProxy.baseUrl + '/CashFlowEngine/CashFlowStudioService.svc/jsAccessEP/';
