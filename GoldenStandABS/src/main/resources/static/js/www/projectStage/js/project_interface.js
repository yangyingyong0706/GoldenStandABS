...
define(function (require) {
    ...
    if (userLanguage && userLanguage.indexOf('en') > -1) {
        ...
        langx.RepurchaseList = 'RepurchaseList'
    } else {
...
function ProjectStatusHistory() {
    trustAction(function (data) {
        var ProjectId = data.ProjectId;
        var StatusDes = data.StatusDesc;
        common.showDialogPage(GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectSource/ProjectStageHistory.html?ProjectId=" + ProjectId, '状态记录', 1200, 640, function () {
...
//}
//清仓回购任务单
function RepurchaseListForProject() {
    trustAction(function (data) {
        var ProjectId = data.ProjectId;
        var StatusDes = data.StatusDesc;
        var TrustId, TrustCode;
...
function ProjectIndex() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectIndex.html";
...
function ProjectAll() {
    ...
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectAll.html?refresh=refresh";
...
function ProjectApproval() {
    webStorage.setItem('showId', 'productManage');
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectApproval.html?enter=ProjectApproval&refresh=refresh";
...
//新建项目
function AddProject() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectAdd.html";
...
function ProjectAssetImport() {
    GSDialog.open(langx.ProjectAssetImport, GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectAssetImport.html", null, function (result) {
        if (result) {
...
function IssuePreparation() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectApproval.html?enter=IssuePreparation";
...
function ProjectSetup() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectApproval.html?enter=ProjectSetup";
...
function TermProject() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectApproval.html?enter=TermProject";
...
function EndofProject() {
    var page = GlobalVariable.TrustManagementServiceHostURL + "projectStage/ProjectApproval/ProjectApproval.html?enter=EndofProject";
