            ...
            var dataSourceOptions = {
                transport: {
                    ...
                    parameterMap: function (options, operation) {
                        ...
                        if (operation == "read") {
                            ...
                            callApi.AddParam({ Name: 'userName', Value: o.dataSource.userName, DBType: 'string' });
                            callApi.AddParam({ Name: 'DimReportingDateID', Value: o.dataSource.reportingDateId, DBType: 'int' });
                ...
                schema: {
                    ...
                    total: function (response) {
                        ...
                        //
                        var total = $.parseJSON(response).total;
                        window.total = total;
                        var params = o.selection;
                        var count;
                        if (params.length != 0) {
                            count = params.length;
                        }
