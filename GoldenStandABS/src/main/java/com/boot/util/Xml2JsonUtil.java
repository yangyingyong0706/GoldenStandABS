...
public class Xml2JsonUtil {
	...
	public static String  xml2JSON(InputStream inputStream) {
...
/*	public static void main(String[] args) {
		// 调用
//		File file = new File("E:\\test\\AccountRule.xml");
//		File file = new File("E:\\test\\test.xml");
//		File file = new File("E:\\test\\A.xml");
//		File file = new File("E:\\test\\test1.xml");
